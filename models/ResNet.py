...
class MOONResNet(nn.Module):
    def __init__(self, block, layers, num_classes=1000):
        self.inplanes = 64
        super(MOONResNet, self).__init__()
        ...
        self.l2 = nn.Linear(512 * block.expansion, 256)
...
def MOONresnet18(num_classes):
    model = MOONResNet(BasicBlock, [2, 2, 2, 2], num_classes=num_classes)
    return model
